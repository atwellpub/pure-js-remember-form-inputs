        ...
        for (var i = 0; i < inputs.length; i++) {
            ...
            switch(type) {
                ...
                case 'checkbox':
                    ...
                    if (typeof checked[value] != 'undefined') {

                        if (checked[value]===true) {
                            inputs[i].checked = "checked";
                            inputs[i].click(); /* redundant - works when above fails */
                        }
                    }
...
/* load class after DOM ready - additionally waits for ready state to become interactive */
